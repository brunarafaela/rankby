...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Visualizando lista de canais seguidos</h1>
	</div>
				...
				<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
					<div class="card card-signin my-5">
						<div class="card-body">
							...
							Você ainda não segue ninguém. Siga seus youtubers favoritos e eles aparecerão aqui.
